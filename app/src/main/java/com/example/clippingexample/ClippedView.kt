...
class ClippedView @JvmOverloads constructor(
    ...
    private val paint = Paint().apply {
        //Smooth edges of what is drawn without affecting shape
        isAntiAlias = true
    ...
    private fun drawClippedRectangle(canvas: Canvas) {
        ...
        //Align to the right side of the text with the origin.
    ...
    private fun drawCombinedClippingExample(canvas: Canvas) {
        ...
        path.addCircle(
            ...
            clipRectTop + circleRadius + rectInset, circleRadius, Path.Direction.CCW
        )
        path.addRect(
